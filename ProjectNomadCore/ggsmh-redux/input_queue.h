...
public:
    ...
    bool GetConfirmedInput(int requested_frame, GameInput* input) {
    ...
    bool GetInput(int requested_frame, GameInput* input) {
...
protected:
    ...
    void AddDelayedInputToQueue(GameInput& input, int frame_number) {
